...
# 1. Definición clara del objeto que busca Vercel
app = Flask(__name__)
    ...
    <section class="section">
        <div class="container">
            ...
            <form method="POST">
                ...
                <div class="control"><button class="button is-link">Confirmar Reserva</button></div>
            </form>
            {% if mensaje %}<div class="notification is-success mt-5">{{ mensaje }}</div>{% endif %}
        </div>
    </section>
</body>
</html>
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                mensaje = "❌ Error en el servidor de Google."
        except:
            mensaje = "❌ Error de conexión."
    return render_template_string(HTML_FORM, mensaje=mensaje)

# Esto le confirma a Vercel que este es el punto de entrada
application = app
